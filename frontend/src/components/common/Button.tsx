...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    danger: 'bg-danger text-white hover:bg-red-600 focus:ring-red-500 active:bg-red-700',
    success: 'bg-success text-white hover:bg-green-600 focus:ring-green-500 active:bg-green-700',
  };
